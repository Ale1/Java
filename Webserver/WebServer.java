    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {  // always on listening for TCP connection requests
                ...
                outputStream.write (("<html><body><p> YOUR MLA ITEMS</p><table><td>").getBytes());
                ...
                outputStream.write(
                            ("</td></table><p> FINISHED BABY</p></body></html>").getBytes()
                );    
   ...
   public String parseInputStream(InputStream stream) {
    ...
    public void run() {
        ...
        try {
                ...
                try { 
                    outputStream.write(("<tr><a href=" + response_url +">item "+ offset + "</a></tr>").getBytes());           
